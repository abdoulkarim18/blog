                    ...
                    <form class="text-left" method="POST" action="{{ route('login') }}">
                        <div class="form">
                            ...
                            <div id="username-field" class="field-wrapper input">
                                ...
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus  placeholder="e.g John_Doe">
                                @error('email')
                            ...
                            <div id="password-field" class="field-wrapper input mb-2">
                                ...
                                <input id="password" name="password" type="password" @error('password') is-invalid @enderror class="form-control" placeholder="Password" name="password" required autocomplete="current-password">
